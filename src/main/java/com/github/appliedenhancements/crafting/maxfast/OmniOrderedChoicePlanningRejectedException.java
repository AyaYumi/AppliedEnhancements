 ...
 *
 * <p>This exception must cross the MAX_FAST fallback boundary unchanged. The
 ...
 */
public final class OmniOrderedChoicePlanningRejectedException
        extends RuntimeException {
    private final long requestedItems;
    private final long maxLinearNativeItems;

    public OmniOrderedChoicePlanningRejectedException(
    ...
    private OmniOrderedChoicePlanningRejectedException(
    ...
    public static OmniOrderedChoicePlanningRejectedException find(
            Throwable failure) {
        ...
        for (Throwable current = failure;
            ...
            if (current instanceof OmniOrderedChoicePlanningRejectedException rejection) {
                return rejection;
            }
        }
        return null;
