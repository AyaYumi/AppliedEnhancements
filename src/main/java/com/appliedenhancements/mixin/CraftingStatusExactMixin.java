...
public abstract class CraftingStatusExactMixin {
    ...
    private void appliedenhancements$writeExact(RegistryFriendlyByteBuf buf, CallbackInfo ci) {
    ...
    private static void appliedenhancements$readExact(RegistryFriendlyByteBuf buf, CallbackInfoReturnable<CraftingStatus> ci) {
