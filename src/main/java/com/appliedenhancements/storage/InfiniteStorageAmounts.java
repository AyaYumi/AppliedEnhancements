...
public final class InfiniteStorageAmounts {
    ...
    public static long probeAmount(long advertisedAmount, int amountPerUnit) {
        ...
        // Use the largest positive request that is aligned to the key's unit size.
        // A finite provider can only return what it actually contains, while an
        // unbounded provider will still satisfy this request in simulation.
    ...
    public static boolean isInfiniteResponse(long advertisedAmount, long requestedAmount, long extractedAmount) {
