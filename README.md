...
| Area | Update |
|---|---|
| Platform | Ports the 1.0.8 feature set to Minecraft 1.20.1, Forge and Java 17, with AE2 15.4.10. |
...
```text
mods/appliedenhancements-1.0.8-forge.jar
```
